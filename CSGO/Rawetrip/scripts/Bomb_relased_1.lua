...
--- @region: unnamed
--- @element: script vars
local script_name = "bomb"
local script_type = "relased"
local script_clan_tag = "bomb"
...
ui_global.export_button = menu_manager_c.new("Main", "First", "Export Config To Clipboard"):button()
ui_global.import_button = menu_manager_c.new("Main", "First", "Import Config From Clipboard"):button()
ui_global.default_button = menu_manager_c.new("Main", "First", "Load Default Config"):button()

ui_global.seperator = menu_manager_c.new("Main", "Second", " "):label()
...
ui_widgets.main_color = menu_manager_c.new("Widgets", "Second", "Main Color", true, ui_widgets.switch_condition):color_picker()
ui_widgets.first_color = menu_manager_c.new("Widgets", "Second", "First Color", true, ui_widgets.switch_condition):color_picker()
ui_widgets.second_color = menu_manager_c.new("Widgets", "Second", "Second Color", true, ui_widgets.switch_condition):color_picker()

ui_widgets.glow_switch = menu_manager_c.new("Widgets", "Second", "Enable Glow", true, ui_widgets.switch_condition):checkbox()
ui_widgets.glow_switch_condition = function() return ui_widgets.switch_condition() and ui_widgets.glow_switch:get() end
ui_widgets.glow_color = menu_manager_c.new("Widgets", "Second", "Glow Color", true, ui_widgets.glow_switch_condition):color_picker()

ui_widgets.sty_seperator = menu_manager_c.new("Widgets", "Second", "    "):label()
ui_widgets.style = menu_manager_c.new("Widgets", "Seconds", "UI style", true, ui_widgets.switch_condition):combo("Clasic", "Modern")

ui_widgets.watermark = menu_manager_c.new("Widgets", "First", "Enable Watermark", true, ui_widgets.switch_condition):checkbox()
ui_widgets.keybinds = menu_manager_c.new("Widgets", "First", "Enable Keybinds", true, ui_widgets.switch_condition):checkbox()
ui_widgets.indicators = menu_manager_c.new("Widgets", "First", "Enable Crosshair Indicators", true, ui_widgets.switch_condition):checkbox()

ui_widgets.hit_log = menu_manager_c.new("Widgets", "First", "Enable On Screen Shot Log", true, ui_widgets.switch_condition):checkbox()
ui_widgets.hit_log_condition = function() return ui_widgets.switch_condition() and ui_widgets.hit_log:get() end
ui_widgets.manage_color = menu_manager_c.new("Widgets", "First", "Manage Colors", true, ui_widgets.hit_log_condition):checkbox()
...
ui_widgets.seperator = menu_manager_c.new("Widgets", "First", "  ", ui_widgets.manage_color_condition):label()

ui_widgets.clan_tag = menu_manager_c.new("Widgets", "First", "Enable Clantag Spammer", true, ui_widgets.switch_condition):checkbox()
...
function condition_anti_aim.create_items()
    ...
    for key, value in ipairs(items) do
        ...
        setup.yaw_offset_type = menu_manager_c.new("Anti-Aim", "Second", name("Yaw Add Type"), true, visible_condition):combo("Clasic", "Modern")
...
function watermark_c.handle()
    ...
    watermark_c.note:get(function(id)
        ...
        local text = {
            ...
            {text = ("| Get good get Bomb.lua |"):format(script_type)}
