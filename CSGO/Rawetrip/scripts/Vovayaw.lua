--[[
    ...
    -- * Script Name: vovkaYaw
    -- * Script Version: 1.4.0
    -- * Script Author: VovaWar
...
--- @region: unnamed
--- @element: script vars
local script_name = "VovaYaw"
local script_type = "stable"
local script_clan_tag = "VovaYaw"
...
keybinds_c.list = {
    ["Min damage"] = keybinds.damage_override,
    ["Double tap nahuy"] = keybinds.double_tap,
    ["On shot a-a"] = keybinds.hide_shots,
    ["shift aa"] = keybinds.slowwalk,
    ["Anti-aim inverter"] = keybinds.flip_desync,
    ["Duck peek assist"] = keybinds.fakeduck,
    ["Quick peek assist"] = keybinds.automatic_peek,
    ["Body enjoyner lol"] = keybinds.body_aim
}
...
hit_log_c.groups = {"ebasos", "chest", "stomach", "left arm", "right arm", "left leg", "right leg", "neck", "gear"}
hit_log_c.miss_types = {
    ["none"] = "?",
    ["resolver"] = "fucking paste",
    ["spread"] = "god dam'n fuck autostop",
    ["occlusion"] = "occlusion",
    ["prediction error"] = "predict. poop",
    ["unregistered"] = "unreg, server so poop"
}
...
local function on_load()
    ...
    local author = ("VovaYaw"):gradient({150, 166, 31, 145}, {109, 169, 240, 255})
