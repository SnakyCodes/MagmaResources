...
ui_anti_aim.preset = menu_manager_c.new("Anti-Aim", "Preset"):combo("None", "Aggressive", "AntiPrimordial", "AntiNeverlose", "Dynamic", "KrakenPreset","Adaptive")
