...
ui_anti_aim.preset = menu_manager_c.new("Anti-Aim", "Preset"):combo("None", "Aggressive", "Alternative", "Brain", "Motion", "Fake Person", "New", "Testing")

ui_anti_aim.roll_angles = menu_manager_c.new("Anti-Aim", "Enable Roll AA [Beta]"):checkbox()
...
ui_global.discord_link = menu_manager_c.new("Discord Link", "Export to Console", "Export to console"):button(function()
    local link = ("UdzKjv4Re7"):gradient({158, 245, 255, 255}, {255, 255, 255, 255})
...
function watermark_c.handle()
    ...
    local text = ("%s | %s "):format(script_name..".beta", nickname)
...
function userp()
    ...
    render.text(fonts.verdana.panel, screen.x/2 - 955 , screen.y/2 - 160, color(255,255,255,255),"#RainNainTrail.lua - version: v2 -beta - "..uname,false,false)
...
if shot_info.result == "Spread" then
    cheat.notify("[ RNT.lua ] Registered shot at " .. shot_info.target_name .. " | Hitbox: - | Hitchance: "  .. shot_info.hitchance .. " | Damage: " .. shot_info.server_damage  .. " | Reason: spread") 
elseif shot_info.result == "Occlusion" then 
    cheat.notify("[ RNT.lua ] Registered shot at " .. shot_info.target_name .. " | Hitbox: - | Hitchance: "  .. shot_info.hitchance .. " | Damage: " .. shot_info.server_damage  .. " | Reason: occlusion") 
elseif shot_info.result == "Hit" then   
    cheat.notify("[ RNT.lua ] Registered shot at " .. shot_info.target_name .. " | Hitbox: " .. shot_info.server_hitbox .. " | Hitchance: "  .. shot_info.hitchance .. " | Damage: " .. shot_info.server_damage  .. " | Reason: -") 
elseif shot_info.result == "resolver" then  
    cheat.notify("[ RNT.lua ] Registered shot at " .. shot_info.target_name .. " | Hitbox: - | Hitchance: "  .. shot_info.hitchance .. " | Damage: " .. shot_info.server_damage  .. " | Reason: resolver")
elseif shot_info.result == "unregistered" then  
    cheat.notify("[ RNT.lua ] Registered shot at " .. shot_info.target_name .. " | Hitbox: - | Hitchance: "  .. shot_info.hitchance .. " | Damage: " .. shot_info.server_damage  .. " | Reason: death")
elseif shot_info.result == "invalid backtrack tick" then 
    cheat.notify("[ RNT.lua ] Registered shot at " .. shot_info.target_name .. " | Hitbox: - | Hitchance: "  .. shot_info.hitchance .. " | Damage: " .. shot_info.server_damage  .. " | Reason: prediction error")
	end
end)
