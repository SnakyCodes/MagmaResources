...
script.data = script:create("Necron", color.new(255, 192, 118), vector2d.new(720, 460), "4.2.0", "Stable")
--- @endregion
...
Http.assets = {
...

    {
        name = "logo_small.png",
        path = "C:\\necron\\assets\\",
        link = "https://raw.githubusercontent.com/kl1ent/CS-GO-Scripting/main/rawetrip/Necron/VectorSmall.png"
    },

    {
        name = "logo_white.png",
        path = "C:\\necron\\assets\\",
        link = "https://raw.githubusercontent.com/kl1ent/CS-GO-Scripting/main/rawetrip/Necron/logo_white.png"
    },

    {
        name = "logo_small_white.png",
        path = "C:\\necron\\assets\\",
        link = "https://raw.githubusercontent.com/kl1ent/CS-GO-Scripting/main/rawetrip/Necron/logo_small_white.png"
    },
...

    {
        name = "DT.png",
        path = "C:\\necron\\assets\\",
        link = "https://raw.githubusercontent.com/kl1ent/CS-GO-Scripting/main/rawetrip/Necron/DT.png"
    },

    {
        name = "HideShots.png",
        path = "C:\\necron\\assets\\",
        link = "https://raw.githubusercontent.com/kl1ent/CS-GO-Scripting/main/rawetrip/Necron/HideShots.png"
    },

    {
        name = "SlowWalk.png",
        path = "C:\\necron\\assets\\",
        link = "https://raw.githubusercontent.com/kl1ent/CS-GO-Scripting/main/rawetrip/Necron/SlowWalk.png"
    },

    {
        name = "FakeDuck.png",
        path = "C:\\necron\\assets\\",
        link = "https://raw.githubusercontent.com/kl1ent/CS-GO-Scripting/main/rawetrip/Necron/FakeDuck.png"
    },

    {
        name = "Peek.png",
        path = "C:\\necron\\assets\\",
        link = "https://raw.githubusercontent.com/kl1ent/CS-GO-Scripting/main/rawetrip/Necron/Peek.png"
    },

    {
        name = "Ideal.png",
        path = "C:\\necron\\assets\\",
        link = "https://raw.githubusercontent.com/kl1ent/CS-GO-Scripting/main/rawetrip/Necron/Ideal.png"
    },

    {
        name = "icon_headshot.png",
        path = "C:\\necron\\assets\\",
        link = "https://raw.githubusercontent.com/kl1ent/CS-GO-Scripting/main/rawetrip/Necron/headshot_image.png"
    },

    {
        name = "penetrate.png",
        path = "C:\\necron\\assets\\",
        link = "https://raw.githubusercontent.com/kl1ent/CS-GO-Scripting/main/rawetrip/Necron/penetrate.png"
    },

    {
        name = "noscope.png",
        path = "C:\\necron\\assets\\",
        link = "https://raw.githubusercontent.com/kl1ent/CS-GO-Scripting/main/rawetrip/Necron/noscope.png"
    },

    {
        name = "icon_suicide.png",
        path = "C:\\necron\\assets\\",
        link = "https://raw.githubusercontent.com/kl1ent/CS-GO-Scripting/main/rawetrip/Necron/icon_suicide.png"
    },
}
--- @endregion
...
assets.china_dt = render.setup_texture(npath .. "\\assets\\DT.png")
assets.china_hs = render.setup_texture(npath .. "\\assets\\HideShots.png")
assets.china_sw = render.setup_texture(npath .. "\\assets\\SlowWalk.png")
assets.china_fd = render.setup_texture(npath .. "\\assets\\FakeDuck.png")
assets.china_peek = render.setup_texture(npath .. "\\assets\\Peek.png")
assets.china_ideal = render.setup_texture(npath .. "\\assets\\Ideal.png")

assets.icon_suicide = render.setup_texture(npath .. "\\assets\\icon_suicide.png")
assets.penetrate = render.setup_texture(npath .. "\\assets\\penetrate.png")
assets.headshot_image = render.setup_texture(npath .. "\\assets\\icon_headshot.png")
assets.noscope = render.setup_texture(npath .. "\\assets\\noscope.png")
...
fonts.weapon = render.setup_weapon_font(13)
...
gui.items = {
    ["Ragebot"] = {
        ["General"] = {
            ...
            items = {
                ...
                gui.update_items({name = "Enable freestand on automatic peek", type = "checkbox"}),
            }
        },
    ...
    ["Anti-Aim"] = {
        ...
        ["Presets"] = {
            settings = gui.update_child({right = true, height = 320}),

            items = {
                gui.update_items({name = "Anti-Aim Presets", type = "combo", items = {"None", "Default", "Conditional", "Dynamic"}}),
                gui.update_items({name = "Trigger", type = "combo", items = player_states})
            }
        },
        ...
        ["Other stuff"] = {
            ...
            items = {
                gui.update_items({name = "Disable fakelags on recharging (only auto)", type = "checkbox"})
            }
        }
    },
    ...
    ["Visuals"] = {
        ["Other stuff"] = {
            ...
            items = {
                ...
                gui.update_items({name = "Enable custom killfeed", type = "checkbox"}),
                gui.update_items({name = "Killfeed max logs", type = "slider", min = 4, max = 20, value = 4, tooltips = {[4] = "infinite"}}),
                gui.update_items({name = "Killfeed max time", type = "slider", min = 0, max = 30, value = 0, tooltips = {[0] = "infinite"}}),
                gui.update_items({name = "Killfeed box scale", type = "slider", min = 0, max = 200, value = 100}),
                gui.update_items({name = "Killfeed size scale", type = "slider", min = 0, max = 200, value = 100}),
            }
        },
        ...
        ["Indicators list"] = {
            ...
            items = {
                gui.update_items({name = "Enable china indicators", type = "checkbox"}),
                ...
                gui.update_items({name = "Circles arrows size", type = "slider", min = 1, max = 20, value = 12}),
    ...
    ["Misc"] = {
        ...
        ["Other stuff"] = {
            ...
            items = {
                gui.update_items({name = "Enable thanos snap", type = "checkbox"}),
                gui.update_items({name = "Enable clantag spammer", type = "checkbox"}),
                gui.update_items({name = "Reset clantag", type = "button", callback = function()
                    engine.set_clantag("")
                end})
            }
        }
    ...
    ["Configs"] = {
        ...
        ["Other stuff"] = {
            ...
            items = {
                ...
                gui.update_items({name = "Enable debug mode", type = "checkbox", state = false}),
...
paint.window = function()
    ...
    if alpha > 0.1 then
        ...
        render.image_ex(assets.logo, x + (width / 2) - (45 / 2) - script_name_width, y - head_height + 9 + (head_height / 2) - (23 / 2), 45, 23, color.new(r, g, b, 255*alpha))
...
update_ui.handle = function()
    ...
    local pressets_var = gui.find("Anti-Aim", "Presets", "Anti-Aim Presets")
    local trigger_var = gui.find("Anti-Aim", "Presets", "Trigger")

    trigger_var:set_visible(pressets_var:get() == 3 and true or false)

    local circles_arrows_var = gui.find("Visuals", "Indicators list", "Enable circles arrows")
    local circles_arrows_size_var = gui.find("Visuals", "Indicators list", "Circles arrows size")

    circles_arrows_size_var:set_visible(circles_arrows_var:get())

    local custom_killfeed = gui.find("Visuals", "Other stuff", "Enable custom killfeed")
    local custom_killfeed_max_logs = gui.find("Visuals", "Other stuff", "Killfeed max logs")
    local custom_killfeed_max_time = gui.find("Visuals", "Other stuff", "Killfeed max time")
    local custom_killfeed_box_scale = gui.find("Visuals", "Other stuff", "Killfeed box scale")
    local custom_killfeed_size_scale = gui.find("Visuals", "Other stuff", "Killfeed size scale")

    custom_killfeed_max_logs:set_visible(custom_killfeed:get())
    custom_killfeed_max_time:set_visible(custom_killfeed:get())
    custom_killfeed_box_scale:set_visible(custom_killfeed:get())
    custom_killfeed_size_scale:set_visible(custom_killfeed:get())

    --- @region: conditional visibility
    for i = 1, #player_states do
        local self = anti_aim[i]

        local value = pressets_var:get() == 3

        local enable_var = gui.find(self.enable[1], self.enable[2], self.enable[3])
        local pitch_var = gui.find(self.pitch[1], self.pitch[2], self.pitch[3])
        local target_yaw_var = gui.find(self.target_yaw[1], self.target_yaw[2], self.target_yaw[3])
        local yaw_offset_var = gui.find(self.yaw_offset[1], self.yaw_offset[2], self.yaw_offset[3])

        local yaw_modifier_var = gui.find(self.yaw_modifier[1], self.yaw_modifier[2], self.yaw_modifier[3])
        local jitter_range_var = gui.find(self.jitter_range[1], self.jitter_range[2], self.jitter_range[3])
        local spin_range_var = gui.find(self.spin_range[1], self.spin_range[2], self.spin_range[3])
        local spin_speed_var = gui.find(self.spin_speed[1], self.spin_speed[2], self.spin_speed[3])

        local desync_type_var = gui.find(self.desync_type[1], self.desync_type[2], self.desync_type[3])
        local desync_range_var = gui.find(self.desync_range[1], self.desync_range[2], self.desync_range[3])
        local inv_desync_range_var = gui.find(self.inv_desync_range[1], self.inv_desync_range[2], self.inv_desync_range[3])
        local body_lean_var = gui.find(self.body_lean[1], self.body_lean[2], self.body_lean[3])
        local inv_body_lean_var = gui.find(self.inv_body_lean[1], self.inv_body_lean[2], self.inv_body_lean[3])

        enable_var:set_visible(trigger_var:get() == i and i > 0 and value)
        pitch_var:set_visible(enable_var:get() and trigger_var:get() == i and value)
        target_yaw_var:set_visible(enable_var:get() and trigger_var:get() == i and value)
        yaw_offset_var:set_visible(enable_var:get() and trigger_var:get() == i and value)

        yaw_modifier_var:set_visible(enable_var:get() and trigger_var:get() == i and value)
        jitter_range_var:set_visible(enable_var:get() and trigger_var:get() == i and value and yaw_modifier_var:get() == 2)
        spin_range_var:set_visible(enable_var:get() and trigger_var:get() == i and value and yaw_modifier_var:get() == 3)
        spin_speed_var:set_visible(enable_var:get() and trigger_var:get() == i and value and yaw_modifier_var:get() == 3)

        desync_type_var:set_visible(enable_var:get() and trigger_var:get() == i and value)
        desync_range_var:set_visible(enable_var:get() and trigger_var:get() == i and value and desync_type_var:get() ~= 1)
        inv_desync_range_var:set_visible(enable_var:get() and trigger_var:get() == i and value and desync_type_var:get() ~= 1)
        body_lean_var:set_visible(enable_var:get() and trigger_var:get() == i and value and desync_type_var:get() ~= 1)
        inv_body_lean_var:set_visible(enable_var:get() and trigger_var:get() == i and value and desync_type_var:get() ~= 1)
    end
    --- @endregion
    ...
    update_ui.change_child_offset("Anti-Aim", "Other stuff", "Anti-Aim", "Roll angles", "other_anti_aim_stuff_child_offset_anim")
    --- @endregion
...
ragebot.revolver_helper_handle = function()
    ...
    for key, ent in ipairs(entitylist.get_players(true)) do
        if ent:is_alive() and not ent:get_dormant() and ent:is_enemy() then
            ...
            if revolver ~= 0 and revolver ~= nil then
                local x, y = bbox.x + (bbox.w / 2), bbox.y - 30 - ((ent:is_zeusable() and gui.find("Visuals", "Other stuff", "Enable zeusable indicator"):get()) and 70 or 10) - (debug_mode_var:get() and 10 or 0)
...
-- freestand on peek
ragebot.freestand_on_peek = function()
    local freestand_on_peek_var = gui.find("Ragebot", "General", "Enable freestand on automatic peek")

    if not freestand_on_peek_var:get() then
        return
    end

    ui.set_bool("Antiaim.freestand", ui.get_keybind_state(keybinds.automatic_peek))
end
--- @endregion
...
anti_aim_functions.real_value = 0
anti_aim_functions.real_switch = false
...
anti_aim_functions.presets_handle = function()
    ...
    local data = anti_aim_functions.presets[anti_aim_preset_var:get()][state]

    --- @region: general
    local pitch = anti_aim_functions.defines["pitch"][data["General"].pitch]
    local traget_yaw = anti_aim_functions.defines["traget_yaw"][data["General"].traget_yaw]
    local yaw_offset = data["General"].yaw_offset(side)
    local yaw_modifier = anti_aim_functions.defines["yaw_modifier"][data["General"].yaw_modifier]
    local jitter_value = data["General"].jitter_value

    --[[if data["General"].yaw_modifier == "Center jitter" then
        if cmd.get_choked_commands() == 0 then
            if anti_aim_functions.real_switch then
                anti_aim_functions.real_value = yaw_offset_var:get() - jitter_value / 2
            else
                anti_aim_functions.real_value = yaw_offset_var:get() + jitter_value / 2
            end

            anti_aim_functions.real_switch = not anti_aim_functions.real_switch
        end

        ui.set_int("Antiaim.yaw_offset", anti_aim_functions.real_value)
    else
        ui.set_int("Antiaim.yaw_offset", yaw_offset_var:get())
    end]]
    ...
    --- @region: desync
    local desync_type = anti_aim_functions.defines["desync_type"][data["Desync"].desync_type]
...
-- conditional anti-aim
for i = 1, #player_states do
    anti_aim[i] = {
        enable = i == 6 and gui.create_new_element("Anti-Aim", "Presets", {name = "[".. string.lower(player_states[i]):sub(1, 2):upper() .."] Enable", type = "hotkey"}) or gui.create_new_element("Anti-Aim", "Presets", {name = "[".. string.lower(player_states[i]) .."] Enable", type = "checkbox"}),
        
        pitch = gui.create_new_element("Anti-Aim", "Presets", {name = "[".. string.lower(player_states[i]):sub(1, 2):upper() .."] Pitch", type = "combo", items = {"None", "Minimal", "Maximal"}}),
        target_yaw = gui.create_new_element("Anti-Aim", "Presets", {name = "[".. string.lower(player_states[i]):sub(1, 2):upper() .."] Target yaw", type = "combo", items = {"Local view", "At targets"}}),
        yaw_offset = gui.create_new_element("Anti-Aim", "Presets", {name = "[".. string.lower(player_states[i]):sub(1, 2):upper() .."] Yaw offset", type = "slider", min = -180, max = 180}),
        yaw_modifier = gui.create_new_element("Anti-Aim", "Presets", {name = "[".. string.lower(player_states[i]):sub(1, 2):upper() .."] Yaw modifier", type = "combo", items = {"Static", "Jitter", "Spin"}}),
        jitter_range = gui.create_new_element("Anti-Aim", "Presets", {name = "[".. string.lower(player_states[i]):sub(1, 2):upper() .."] Jitter range", type = "slider", min = 1, max = 180}),
        spin_range = gui.create_new_element("Anti-Aim", "Presets", {name = "[".. string.lower(player_states[i]):sub(1, 2):upper() .."] Spin range", type = "slider", min = 1, max = 180}),
        spin_speed = gui.create_new_element("Anti-Aim", "Presets", {name = "[".. string.lower(player_states[i]):sub(1, 2):upper() .."] Spin speed", type = "slider", min = 1, max = 15}),

        desync_type = gui.create_new_element("Anti-Aim", "Presets", {name = "[".. string.lower(player_states[i]):sub(1, 2):upper() .."] Desync type", type = "combo", items = {"None", "Static", "Jitter"}}),
        desync_range = gui.create_new_element("Anti-Aim", "Presets", {name = "[".. string.lower(player_states[i]):sub(1, 2):upper() .."] Desync range", type = "slider", min = 1, max = 60}),
        inv_desync_range = gui.create_new_element("Anti-Aim", "Presets", {name = "[".. string.lower(player_states[i]):sub(1, 2):upper() .."] Inverted desync range", type = "slider", min = 1, max = 60}),
        body_lean = gui.create_new_element("Anti-Aim", "Presets", {name = "[".. string.lower(player_states[i]):sub(1, 2):upper() .."] Body lean", type = "slider", min = 0, max = 100}),
        inv_body_lean = gui.create_new_element("Anti-Aim", "Presets", {name = "[".. string.lower(player_states[i]):sub(1, 2):upper() .."] Inverted body lean", type = "slider", min = 0, max = 100}),
    }
end

anti_aim_functions.conditional_handle = function()
    local pressets_var = gui.find("Anti-Aim", "Presets", "Anti-Aim Presets")

    if pressets_var:get() ~= 3 then
        return
    end
    ...
    local PlayerStateIndex = 1

    local velocity = Player:get_velocity():length_2d() < 2
    ...
    local slowwalk_key = ui.get_keybind_state(keybinds.slowwalk)
    local key_var = gui.find(anti_aim[6].enable[1], anti_aim[6].enable[2], anti_aim[6].enable[3])

    if key_var:get() then
        PlayerStateIndex = 6
    else
        if on_ground and gui.unpack(anti_aim[5].enable):get() then
            PlayerStateIndex = 5
        else
            if slowwalk_key and gui.unpack(anti_aim[4].enable):get() then
                PlayerStateIndex = 4
            else
                if velocity and gui.unpack(anti_aim[2].enable):get() then
                    PlayerStateIndex = 2
                elseif not velocity and gui.unpack(anti_aim[3].enable):get() then
                    PlayerStateIndex = 3
                end
            end
        end
    ...
    if gui.unpack(anti_aim[PlayerStateIndex].enable):get() then
        ui.set_bool("Antiaim.enable", gui.unpack(anti_aim[PlayerStateIndex].enable):get())
        ui.set_int("0Antiaim.pitch", gui.unpack(anti_aim[PlayerStateIndex].pitch):get() - 1)
        ui.set_int("0Antiaim.base_angle", gui.unpack(anti_aim[PlayerStateIndex].target_yaw):get() - 1)
        ui.set_int("Antiaim.yaw_offset", gui.unpack(anti_aim[PlayerStateIndex].yaw_offset):get())
        ui.set_int("0Antiaim.yaw", gui.unpack(anti_aim[PlayerStateIndex].yaw_modifier):get() - 1)

        if gui.unpack(anti_aim[PlayerStateIndex].yaw_modifier):get() == 2 then
            ui.set_int("0Antiaim.range", gui.unpack(anti_aim[PlayerStateIndex].jitter_range):get())
        elseif gui.unpack(anti_aim[PlayerStateIndex].yaw_modifier):get() == 3 then
            ui.set_int("0Antiaim.range", gui.unpack(anti_aim[PlayerStateIndex].spin_range):get())
            ui.set_int("0Antiaim.speed", gui.unpack(anti_aim[PlayerStateIndex].spin_speed):get())
        end

        ui.set_int("0Antiaim.desync", gui.unpack(anti_aim[PlayerStateIndex].desync_type):get() - 1)

        if brute_time_remains <= 0 then
            ui.set_int("0Antiaim.desync_range", gui.unpack(anti_aim[PlayerStateIndex].desync_range):get())
            ui.set_int("0Antiaim.inverted_desync_range", gui.unpack(anti_aim[PlayerStateIndex].inv_desync_range):get())
        end

        ui.set_int("0Antiaim.body_lean", gui.unpack(anti_aim[PlayerStateIndex].body_lean):get())
        ui.set_int("0Antiaim.inverted_body_lean", gui.unpack(anti_aim[PlayerStateIndex].inv_body_lean):get())
    end
end

-- disable fakelag on dt
anti_aim_functions.fakelag_cache = ui.get_int("Antiaim.fake_lag_limit")

anti_aim_functions.disable_fakelag = function()
    local disable_fakelag_var = gui.find("Anti-Aim", "Other stuff", "Disable fakelags on recharging (only auto)")

    if not disable_fakelag_var:get() then
        return
    end
    ...
    if globalvars.get_dt_recharging() then
        if PlayerWeapon:get_name() == "SCAR-20" or PlayerWeapon:get_name() == "G3SG1" then
            ui.set_int("Antiaim.fake_lag_limit", 0)
        else
            ui.set_int("Antiaim.fake_lag_limit", anti_aim_functions.fakelag_cache)
        end
    else
        ui.set_int("Antiaim.fake_lag_limit", anti_aim_functions.fakelag_cache)
    end
...
-- custom killfeed
visual_functions.killfeed = {}
visual_functions.killfeed.data = {}

visual_functions.killfeed.icons = {
    ["glock"] = "D",
    ["cz75a"] = "I",
    ["p250"] = "F",
    ["fiveseven"] = "C",
...
visual_functions.killfeed.player_death = function(event)
    local Player = entitylist.get_local_player()

    local Attacker = entitylist.get_player_by_index(engine.get_player_for_user_id(event:get_int("attacker")))
    local Target = entitylist.get_player_by_index(engine.get_player_for_user_id(event:get_int("userid")))
    local Assister = entitylist.get_player_by_index(engine.get_player_for_user_id(event:get_int("assister")))

    if Attacker ~= Player and Target ~= Player then
        return
    end

    table.insert(visual_functions.killfeed.data, {
        attacker = Attacker:get_name(),
        target = Target:get_name(),
        hs = event:get_bool("headshot"),
        assister = Assister:get_name(),
        penetrated = event:get_int("penetrated"),
        noscope = event:get_bool("noscope"),
        weapon = event:get_string("weapon"),
        time = globalvars.get_curtime(),
        teams = {
            Target:get_team(),
            Attacker:get_team()
        }
...
visual_functions.killfeed.handle = function()
    local custom_killfeed = gui.find("Visuals", "Other stuff", "Enable custom killfeed")

    console.set_int("cl_drawhud_force_deathnotices", custom_killfeed:get() and -1 or 0)

    if not custom_killfeed:get() then
        return
    end
    ...
    local max_logs = gui.find("Visuals", "Other stuff", "Killfeed max logs"):get()
    local max_time = gui.find("Visuals", "Other stuff", "Killfeed max time"):get()
    local box_scale = gui.find("Visuals", "Other stuff", "Killfeed box scale"):get()
    local size_scale = gui.find("Visuals", "Other stuff", "Killfeed size scale"):get()/100

    local r, g, b, a = 227, 181, 255, 255

    local safezone = {
        x = console.get_float("safezonex"),
        y = console.get_float("safezoney")
    }
    ...
    for i, shot in ipairs(visual_functions.killfeed.data) do
        local alpha = math.min((globalvars.get_curtime() - shot.time) * 2, 1)

        local xoffset = ((18 + 8) * size_scale) * (i - 1)
        local attacker_string = shot.attacker .. ((#shot.assister < 1) and "" or (" + " .. shot.assister))
        local attacker_size = render.get_text_width(fonts.default, attacker_string)
        ...
        if shot.target == shot.attacker then
            ...
            local weapon_icon = visual_functions.killfeed.icons[shot.weapon]
            local w, h = render.get_text_width(fonts.weapon, weapon_icon), render.get_text_height(fonts.weapon, weapon_icon)

            size = size + w*scale + 2
        end

        local target_size = render.get_text_width(fonts.default, shot.target)

        size = size + target_size + 8

        local new_width, new_height = size * alpha * box_scale / 100*size_scale, 18*size_scale

        local new_x, new_y = Screen.x, y/2 * (1 - safezone.y) + padding.y - 2 + xoffset
        new_x = new_x - padding.x

        render.gradient(new_x - new_width, new_y, new_width, new_height, color.new(r, g, b, 0), color.new(r, g, b, (120 / 255) * a), 0)

        local offset = 4
        local r, g, b, a = 200, 200, 200, 255

        if shot.teams[1] == 3 then -- ct
            r, g, b, a = 204, 204, 255, 155
        elseif shot.teams[1] == 2 then
            r, g, b, a = 255, 204, 204, 155
        end

        local shot_target_height = render.get_text_height(fonts.default, shot.target)
        render.text(fonts.default, new_x - offset - target_size - 10, new_y + (new_height / 2) - (shot_target_height / 2), color.new(r, g, b, a * alpha), shot.target, true)
        ...
        if shot.hs then
            ...
            render.image_ex(assets.headshot_image, new_x - offset - target_size - w*scale - 10, new_y + (new_height / 2) - (shot_target_height / 2), w*scale, h*scale, color.new(255, 255, 255, 255 * alpha))
        ...
        if shot.penetrated > 0 then
            ...
            render.image_ex(assets.penetrate, new_x - offset - target_size - w*scale - 12, new_y + (new_height / 2) - (shot_target_height / 2), w*scale, h*scale, color.new(255, 255, 255, 255 * alpha))
            offset = offset + w*scale
        end
        ...
        if shot.noscope then
            ...
            render.image_ex(assets.noscope, new_x - offset - target_size - w*scale - 12, new_y + (new_height / 2) - (shot_target_height / 2), w*scale, h*scale, color.new(255, 255, 255, 255 * alpha))
            offset = offset + w*scale
        end
       ...
       if shot.target == shot.attacker then
            ...
            render.image_ex(assets.icon_suicide, new_x - offset - target_size - w*scale - 14, new_y + (new_height / 2) - (shot_target_height / 2), w*scale, h*scale, color.new(255, 255, 255, 255 * alpha))
            offset = offset + w*scale + 2
        else
            local weapon_icon = visual_functions.killfeed.icons[shot.weapon]
            local w, h = render.get_text_width(fonts.weapon, weapon_icon), render.get_text_height(fonts.weapon, weapon_icon)

            render.text(fonts.weapon, new_x - offset - target_size - w*scale - 14 - (w / 2), new_y + (new_height / 2) - (shot_target_height / 2), color.new(255, 255, 255, 255 * alpha), weapon_icon)
        ...
        local weapon_icon = visual_functions.killfeed.icons[shot.weapon]
        local w, h = render.get_text_width(fonts.weapon, weapon_icon), render.get_text_height(fonts.weapon, weapon_icon)
        local attacker_string_width = render.get_text_width(fonts.default, attacker_string)
        render.text(fonts.default, new_x - offset - attacker_string_width - target_size - (w / 2) - 16, new_y + (new_height / 2) - (shot_target_height / 2), color.new(r, g, b, a * alpha), attacker_string, true)
        
        if max_logs ~= 4 and #visual_functions.killfeed.data > max_logs then
            table.remove(visual_functions.killfeed.data, i)
        end

        if max_time ~= 0 and shot.time + max_time - globalvars.get_curtime() <= 0 then
            table.remove(visual_functions.killfeed.data, i)
        end
    end
end
...
visual_functions.china_indicators.create = function(condition, image, index)
    ...
    if condition and not data.switch[index] then
        data.y_array[index] = animation.lerp(data.y_array[index], 20, 12)
        data.alpha[index] = animation.lerp(data.alpha[index], 1, 12)

        if data.alpha[index] >= 0.99 then
            data.switch[index] = true
        end
    end

    if data.switch[index] then
        data.alpha[index] = animation.lerp(data.alpha[index], 0, 12)
    end

    if not condition then
        data.switch[index] = false

        data.y_array[index] = animation.lerp(data.y_array[index], 0, 12)
        data.alpha[index] = animation.lerp(data.alpha[index], 0, 12)
    end
...
visual_functions.china_indicators.handle = function()
    local china_indicators_var = gui.find("Visuals", "Indicators list", "Enable china indicators")

    if not china_indicators_var:get() then
        return
    end
...
visual_functions.circles_arrows = function()
    ...
    local size = circles_arrows_size_var:get()
    local sharpness = 4
...
visual_functions.info_panel = function()
    ...
    if info_panel_type_var:get() == 1 then
        ...
        render.image_ex(assets.user_avatar, x, y - (30 / 2), 30, 30, color.new(255, 255, 255, 255), 2)
...
local resModeToString = {[0] = "PREVIOUS_GFY",[1] = "ZERO",[2] = "FIRST",[3] = "SECOND",[4] = "LOW_FIRST",[5] = "LOW_SECOND"}
...
visual_functions.debug_mode = function()
    ...
    local last_target_to_player = entitylist.get_player_by_index(resolver_optional.get_last_target())

    if last_target_to_player ~= nil then
        table.insert(text, {text = ("r_last_target: %s"):format(last_target_to_player:get_name())})
        table.insert(text, {text = ("r_last_target_index: %s"):format(last_target_to_player:get_index())})
        table.insert(text, {text = ("r_last_target_solve: %s"):format(resModeToString[resolver_optional.get_solve(resolver_optional.get_last_target())])})
    end

    table.insert(text, {text = ("p_body_yaw: %s"):format(Player:get_body_yaw())})
    table.insert(text, {text = ("p_state: %s"):format(Player:get_state():lower())})
...
visual_functions.zeus_indicator_handle = function()
    ...
    for key, ent in ipairs(entitylist.get_players(true)) do
        if ent:is_alive() and not ent:get_dormant() and ent:is_enemy() and ent:is_zeusable() then
            ...
            render.image_ex(assets.zeus_logo, x - (40 / 2), y - 50, 50, 50, color.new(255, 255, 255, 255))
        end
    end
end
...
visual_functions.crosshair_default = function()
    ...
    local additional = circles_arrows_var:get() and circles_arrows_size_var:get() + 45 or 45
    ...
    if indicators_type_var:get() == 1 then
        ...
        render.image_ex(assets.logo, x - (width / 2), y - (height / 2), width, height, color.new(r, g, b, 255))
    elseif indicators_type_var:get() == 2 then
        y = y - (circles_arrows_var:get() and math.min((circles_arrows_size_var:get() / 2) - 5, 13) or 13)
...
visual_functions.snaplines_handle = function()
    ...
    local best_enemy = entity.get_best_enemy()

    if best_enemy:is_enemy() and best_enemy:is_alive() and not best_enemy:get_dormant() then
        local ent_hitbox = best_enemy:get_absorigin()
...
visual_functions.create_solus_window = function(x, y, firts_width, width, height, color, type)
    ...
    if type == 1 then
        ...
        render.rect_filled_rounded(x, y, width + 4, height, 10, 3, color.new(0, 0, 0, (146 / 255) * a))
        render.end_cliprect()

        render.begin_cliprect(x + firts_width - 1, y, width + 1, height)
        render.blur(x + firts_width, y, width, height, (255 / 255) * a)
        render.rect_filled_rounded(x + firts_width - 5, y, width + 5, height, 10, 3, color.new(10, 10, 10, (255 / 255) * a))
        render.end_cliprect()
    end
end
...
visual_functions.solus_watermark = function()
    ...
    local r, g, b = color.unpack(script.data:get_color())
    local image_size = vector2d.new(22, 11)
    local firts_width, height, width = image_size.x + 10, 25, render.measure_multitext(text) + 11
    ...
    render.image_ex(assets.logo_small, x + 5, y + (height / 2) - (image_size.y / 2), image_size.x, image_size.y, color.new(r, g, b, 255))
...
visual_functions.spectators_list = function()
    ...
    local height_offset, head_height = 42, 30
    local width, height = animation.new("spectators::width", 85 + maximum_offset, 8), animation.new("spectators::height", items_offset + 22, 8)
    ...
    render.rect_filled_rounded(x, y + 10, width, head_height, 10, 3, color.new(0, 0, 0, 146*m_alpha))

    --render.text(fonts.default, x + (width / 2) - (text_width / 2), y + (head_height / 2) - (text_height / 2) + 7, color.new(255, 255, 255, m_alpha*255), text)
    local image_size = vector2d.new(22, 11)
    render.image_ex(assets.logo_small, x + (width / 2) - (image_size.x / 2), y + (head_height / 2) - (image_size.y / 2) + 8, image_size.x, image_size.y, color.new(r, g, b, m_alpha*255))
    render.end_cliprect()

    render.begin_cliprect(x, y + head_height + 5, width, height)
    render.blur(x, y + head_height + 5, width, height - 5, 255*m_alpha)
    render.blur(x, y + head_height + 5, width, height - 5, 255*m_alpha)
    render.rect_filled_rounded(x, y + head_height, width, height, 10, 3, color.new(10, 10, 10, 255*m_alpha))
    render.end_cliprect()
    ...
    for c_name, c_ref in pairs(data.active) do
        ...
        render.text(fonts.default, x + 12, y + height_offset + (image_size / 2) - (name_height / 2) + 3, color.new(255, 255, 255, m_alpha*c_ref.alpha*255), c_ref.name)
        
        if c_ref.avatar ~= nil then
            render.image_ex(c_ref.avatar, x + width - image_size - 12, y + height_offset + 3, image_size, image_size, color.new(255, 255, 255, m_alpha*c_ref.alpha*255), 15)
        end
...
visual_functions.keybinds_list_data = {active = {}, modes = {"always", "hold", "toggle", "disabled"}}
visual_functions.keybinds_list_data.list = {
    ...
    {name = "Freestand", path = gui.find("Ragebot", "General", "Freestand key")},
}
...
visual_functions.keybinds = function()
    ...
    for c_name, c_data in pairs(data.list) do
        ...
        item_active = (c_data.key == nil and c_data.path ~= nil) and c_data.path:get() or item_active
        ...
        if item_active then
            ...
            data.active[c_name].offset = text_width
            data.active[c_name].mode = data.modes[(c_data.key == nil and c_data.path ~= nil) and c_data.path:get(true)[2] or (ui.get_keybind_mode(c_data.key) + 2)]
    ...
    local height_offset, head_height = 42, 30
    local width, height = animation.new("keybinds::width", 85 + maximum_offset, 8), animation.new("keybinds::height", items_offset + 22, 8)
    ...
    --render.text(fonts.default, x + (width / 2) - (text_width / 2), y + (head_height / 2) - (text_height / 2) + 7, color.new(255, 255, 255, m_alpha*255), text)
    local image_size = vector2d.new(22, 11)
    render.image_ex(assets.logo_small, x + (width / 2) - (image_size.x / 2), y + (head_height / 2) - (image_size.y / 2) + 8, image_size.x, image_size.y, color.new(r, g, b, 255*m_alpha))
    render.end_cliprect()
    ...
    for c_name, c_ref in pairs(data.active) do
        ...
        render.text(fonts.default, x + 12, y + height_offset + 3, color.new(255, 255, 255, m_alpha*c_ref.alpha*255), c_ref.name)
        render.text(fonts.default, x + width - render.get_text_width(fonts.default, key_type) - 12, y + height_offset + 3, color.new(255, 255, 255, m_alpha*c_ref.alpha*100), key_type)
...
visual_functions.debug_esp = function()
    ...
    for key, ent in ipairs(entitylist.get_players(true)) do
        if ent:is_alive() and not ent:get_dormant() and ent:is_enemy() then
            ...
            local x, y = bbox.x + (bbox.w / 2), bbox.y - 30 - ((ent:is_zeusable() and gui.find("Visuals", "Other stuff", "Enable zeusable indicator"):get()) and 70 or 10)
...
miscellaneous_functions.hitlogs_groups = {"generic", "head", "chest", "stomach", "left arm", "right arm", "left leg", "right leg", "neck", "?", "gear"}
...
miscellaneous_functions.shot_event = function(shot)
    if shot.result ~= "Hit" then
        local text = ("shot due to %s"):format(shot.result == "None" and "unknown" or shot.result:lower())
...
miscellaneous_functions.hitlogs = function()
    ...
    for key, value in ipairs(miscellaneous_functions.hitlogs_list) do
        ...
        local text = value.type .. " " .. value.text
        local text_width, text_height = render.get_text_width(fonts.default, text) + 50, render.get_text_height(fonts.default, text)

        local new_x, new_y = x + (10*value.alpha), y + hitlogs_offset

        render.blur(new_x, new_y, text_width, 30, 255*value.alpha)
        render.rect_filled_rounded(new_x, new_y, text_width, 30, 10, 4, color.new(0, 0, 0, 146*value.alpha))

        render.text(fonts.default, new_x + 10, new_y + (30 / 2) - (text_height / 2), color.new(255, 255, 255, 255*value.alpha), text)

        local image_size = vector2d.new(22, 11)
        render.image_ex(assets.logo_small, new_x + text_width - image_size.x - 10, new_y + (30 / 2) - (image_size.y / 2), image_size.x, image_size.y, color.new(r, g, b, 255*value.alpha))
...
-- thanos snap
miscellaneous_functions.thanos_snap = function()
    local thanos_snap_var = gui.find("Misc", "Other stuff", "Enable thanos snap")

    console.set_int("cl_ragdoll_physics_enable", thanos_snap_var:get() and 0 or 1)
end
--- @endregion
...
config_system.load = function()
    ...
    if #ragebot.anti_brute.list > antibrute_phases then
        while #ragebot.anti_brute.list > antibrute_phases do
            ragebot.anti_brute.remove_phase()
        end
    else
        while #ragebot.anti_brute.list < antibrute_phases do
            ragebot.anti_brute.add_new_phase()
    ...
    for i = 1, antibrute_phases do
        local limits_var = gui.find("Ragebot", "Anti-Bruteforce", "Fake limit phase ".. i)

        limits_var:set(json_to_table["Ragebot"]["Anti-Bruteforce"]["Fake limit phase ".. i].value)
    end
end
...
cheat.RegisterCallback("on_paint", function()
    ...
    visual_functions.killfeed.handle()
    ...
    miscellaneous_functions.thanos_snap()
...
cheat.RegisterCallback("on_createmove", function()
    anti_aim_functions.disable_fakelag()
    anti_aim_functions.conditional_handle()
...
cheat.RegisterCallback("on_shot", function(shot)
    miscellaneous_functions.shot_event(shot)
end)
...
events.register_event("player_death", function(event)
    visual_functions.killfeed.player_death(event)
end)

events.register_event("round_start", function(event)
    visual_functions.killfeed.data = {}
end)
--- @endregion