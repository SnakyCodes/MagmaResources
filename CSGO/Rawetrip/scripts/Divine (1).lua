--[[
    ...
    -- * Script Name: Sweet
    -- * Script Version: 14
    -- * Script Author: Arc Warden#3740
    -- * Fixed by: Arc Warden#3740
...
(function()
    ...
    console.print_color("Sweet.lua Discord Server: https://discord.gg/UdzKjv4Re7\n", color_c.new(122, 195, 250))
	console.print_color("Fixed By: Klient#1690\n\n", color_c.new(122, 195, 250))

	cheat.notify("Sweetlua Loaded, Go Dominate pablick!")
end)()
--- @endregion
